...
module.exports = "/country.e0131cb2.hbs";
},{}],"index.js":[function(require,module,exports) {
"use strict";

var _fetchCountries = _interopRequireDefault(require("../src/fetchCountries.js"));
...
function showCountries(e) {
  ...
  _fetchCountries.default.fetchCountries(searchQuery).then(renderCountryCard).catch(errorFetch).finally(function () {
    return form.reset();
  });
}
...
function renderCountryCard(country) {
  ...
  console.log(markup);
  cardContainerRef.insertAdjacentHTML("afterbegin", markup);
}

function errorFetch(error) {
  alert('You enter an undefiend country');
}
},{"../src/fetchCountries.js":"fetchCountries.js","../src/country.hbs":"country.hbs"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
